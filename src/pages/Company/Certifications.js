        ...
        <div class="container-fluid bg-primary py-5 bg-header">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Certification</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Certification</a>
                </div>
            </div>
        </div>
        <div class="pb-3 pt-5 mt-5 bg-light text-center"> 
<div class="container">
<h1 class="m-0">Cheap website packages</h1>
...
<div class="p-4">
  ...
  <ul class="list price_item ">
      ...
      <a class="btn btn-danger btn-lg btn-block" href="/cheap-website-packages/input-form/single-page/">Order Now</a>
    </div>
    </div>
  </div>
  ...
  <div class="col-md-4 mb-4">
    <div class="shadow rounded">
      <div class="p-4 bg-success text-white rounded-top">
...
<div class="container py-4 p-0">
	<h2 class="mb-3 h3">Cheap website creation</h2>
  <p>Unbelievable offer from one of the pioneer website companies in Chennai, India, avail our Cheap website design service at
     Rs.1000 onwards, cheap hosting service at Rs.500 onwards, cheap domain Rs.100 onwards, affordable single page website and 
     landing page design work delivered within 48 hrs.</p>
