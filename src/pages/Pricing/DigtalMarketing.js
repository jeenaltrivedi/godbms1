      ...
      <div class="container-fluid bg-primary py-5 bg-header">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Digtal Marketing</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">DigtalMarketing</a>
                </div>
            </div>
        </div>
      <div class="pb-3 pt-5 mt-5 bg-light text-center"> 
<div class="container">
<h1 class="m-0">Digital Marekting website packages</h1>
...
<div class="container py-4 p-2">
	<h2 class="mb-3 h3">Digital Markerting website creation</h2>
