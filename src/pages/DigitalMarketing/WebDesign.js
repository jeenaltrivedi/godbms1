      ...
      <div class="container-fluid bg-primary py-5 bg-header">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">WebDesign</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">WebDesign</a>
                </div>
            </div>
        </div>
...
<div className='container pt-4 '>
				...
				<p><span class="dropcap paregraph text-primary bg-primary bg-opacity-10 rounded px-2">A</span>
...
<div class="container">
<h1 class="m-0">Digital Marketing 360 website packages</h1>
