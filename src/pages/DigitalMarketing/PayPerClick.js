  ...
  return (
    <div>
      ...
      <div class="container-fluid bg-primary py-5 bg-header">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">PayPerClick</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">PayPerClick</a>
                </div>
            </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8 pt-0 mx-auto  ">
              <div class="col-12 pt-4">
                <h1 className='form-heading'>Per Pay Click Markerting - PPC</h1>
                <hr class="divider" />
                <ul className='pt-2 p-1 pb-1'>
                  <li className='space'><i class="fa fa-check-circle" aria-hidden="true"></i> Choose your campaign type based on your objective.</li>
                  <li className='space'><i class="fa fa-check-circle" aria-hidden="true"></i> Refine your settings and targeting (audiences, devices, locations, schedule, etc.).</li>
                  <li className='space'><i class="fa fa-check-circle" aria-hidden="true"></i> Provide your budget and bidding strategy.</li>
                  <li className='space'><i class="fa fa-check-circle" aria-hidden="true"></i> Input your destination URL (landing page).</li>
                  <li className='space'><i class="fa fa-check-circle" aria-hidden="true"></i>  Build your ad.</li>
                </ul>
      ...
      <div className='container pt-4 '>
        <h3 className="text-center">Per Pay Click Markerting - PPC</h3>
        <p className='content p-1'><span class="dropcap paregraph text-primary bg-primary bg-opacity-10 rounded px-2">A</span>
          PPC stands for pay-per-click, a model of digital advertising where the advertiser pays a fee each time one of their
          ads is clicked. Essentially, you’re paying for targeted visits to your website (or landing page or app).
          When PPC is working correctly, the fee is trivial because the click is worth more than what you pay for it.
          For example, if you pay $3 for a click, but the click results in a $300 sale, then you’ve made a hefty profit.

          PPC ads come in different shapes and sizes (literally), and can be made up of text, images, videos, or a combination.
          They can appear on search engines, websites, social media platforms, and more.</p>
        {/* Add the rest of your content */}
      </div>
      <div class="pb-3 pt-5 mt-5 bg-light text-center">
        <div class="container">
          <h3 class="m-0">Per Pay Click Markerting website packages</h3>
      ...
      <div class="container py-4 p-2">
        <h3 class="mb-3 ">Per Pay Click Markerting website creation</h3>
        <p>Creating content for a pay-per-click (PPC) marketing website is crucial to attract and convert visitors into customers.
          The content should be informative, persuasive, and optimized for both users and search engines. Below, I've outlined the
          essential content elements you should consider when creating a PPC marketing website.</p>
        <li className='p-2'>Contact Information</li>
        <li className='p-2'>Client Testimonials</li>
        <li className='p-2'>Portfolio or Case Studies</li>
        <li className='p-2'>CTAs Throughout</li>
        <li className='p-2'>Privacy Policy and Terms of Service</li>
        <li className='p-2'>Trust Signals</li>
      </div>
      <Footer />
    </div>
  );
